...
class RelayContainerTestCase(unittest.TestCase): 
    ...
    def test_add_relay(self):
        prev_size = self.con.getSize()
        self.con.add_relay(1, True)
        self.assertGreater(self.con.getSize(), prev_size, "add_relay FAILED: size did not increase")
        ...
        self.con.add(28, True) #this doesn't exist
    ...
    def test_get_relay_index(self):
        ...
        self.assertIsInstance(self.relay, "get_relay_index FAILED: attempted to get relay at out of bounds index (<)")
